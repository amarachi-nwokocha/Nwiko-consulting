...
const Mail = () => {
  return (
    <div className='text-center min-h-[40vh] w-full  md:px-10 px-5 pt-10 bg-brightBackGround'>
       ...
       <a href="mailto:example@email.com?subject=Hello&body=I%20want%20to%20work%20with%20you." className='bg-blue w-10 h-10 p-4 rounded-md font-semibold text-2xl text-white border-2 border-solid border-yellow'>
    Send Mail
  </a>
       </button>
    </div>
